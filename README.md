...
**Greetings** Greeting App with Rails and React. Implement a connection between a Ruby on Rails as back-end and React front-end to display a random greeting messages along with providing API endpoint.
...
```
git clone https://github.com/Jawad-Nazari/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/jonas-45/hello-rails-react/issues).
